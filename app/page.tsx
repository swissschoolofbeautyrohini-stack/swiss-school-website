...
<option value="Nutrition & Wellness">Nutrition & Wellness</option>
                ...
                <button type="submit" className="w-full py-4 rounded-xl bg-gradient-to-r from-brand-gold to-yellow-600 text-black font-bold text-lg shadow-[0_4px_14px_rgba(212,175,55,0.4)] hover:shadow-[0_6px_20px_rgba(212,175,55,0.6)] hover:-translate-y-0.5 transition-all">
                  Submit Enquiry
                </button>
              </form>
            </div>
